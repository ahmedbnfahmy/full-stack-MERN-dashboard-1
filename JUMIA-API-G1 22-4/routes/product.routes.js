...
//without verfiy
router.post("/",express.static(path.join(__dirname, 'uploads')), upload.array('files'), products.createProduct);// 
router.put("/:id", express.static(path.join(__dirname, 'uploads')), upload.array('files'), products.updateProduct);
router.get("/", products.getAllProducts); //
router.get("/prdOfSearch", products.getAllProductsOfSearch);
router.get("/:id", products.getProduct); //
router.get("/cat/:category", products.getProductsOfCategory); //
router.get("/subcat/:subCategory", products.getProductsOfSubCategory); //
router.get("/details/:id", products.getProductdetails);//
router.get("/latest/Products", products.getlatestProducts);//
router.get("/chart/productCategories",products.getProductCategories);//
