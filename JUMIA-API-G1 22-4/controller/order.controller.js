...
const Incomes = require("../models/incomes.module.js");
...
exports.getAllOrderFilter = async (req, res) => {
    try {
      let query;
      let total;
      ...
      query = Order.find({ ...(req.body.search && { name: searchObject }) });
      total = await Order.countDocuments(); //conter of all todos
  ...
  exports.deleteOrder = async (req, res) => {
    ...
    try {
      ...
      console.log('hello from delete error');
    }
  };


//create order
exports.createOrderByAdmin = (req, res) => {
