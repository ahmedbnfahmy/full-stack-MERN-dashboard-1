...
exports.getSearchedCategoryList = async (req, res) => {
  try {
    let query;
    ...
    query = category.find({ ...(req.body.search && { email: searchObject }) });

    total = await category.countDocuments(); //conter of all todos
